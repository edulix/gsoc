...
Nepomuk::SourceCode::SourceCode( ResourceManager* manager )
  : PlainTextDocument( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#SourceCode"), manager )
{
}
...
Nepomuk::SourceCode::SourceCode( const QString& uri, ResourceManager* manager )
  : PlainTextDocument( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#SourceCode"), manager )
{
}
...
Nepomuk::SourceCode::SourceCode( const QUrl& uri, ResourceManager* manager )
  : PlainTextDocument( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#SourceCode"), manager )
{
}
...
Nepomuk::SourceCode::SourceCode( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::SourceCode::SourceCode( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : PlainTextDocument( uri, type, manager )
{
}
