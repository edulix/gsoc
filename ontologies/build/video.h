 ...
 */
    ...
    public:
        ...
        Video( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Video instance representing the resource
         * referenced by \a uri.
         */
        Video( const QUrl& uri );
        Video( const QUrl& uri, ResourceManager* );
        ~Video();
    ...
    protected:
       ...
       Video( const QString& uri, const QUrl& type, ResourceManager* );
       Video( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
