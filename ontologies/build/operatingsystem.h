 ...
 */
    ...
    public:
        ...
        OperatingSystem( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new OperatingSystem instance representing the resource
         * referenced by \a uri.
         */
        OperatingSystem( const QUrl& uri );
        OperatingSystem( const QUrl& uri, ResourceManager* );
        ~OperatingSystem();
    ...
    protected:
       ...
       OperatingSystem( const QString& uri, const QUrl& type, ResourceManager* );
       OperatingSystem( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
