 ...
 */
    ...
    public:
         ...
         */
        OrganizationContact();
        OrganizationContact( ResourceManager* );
        /**
        ...
        OrganizationContact( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new OrganizationContact instance representing the resource
         * referenced by \a uri.
         */
        OrganizationContact( const QUrl& uri );
        OrganizationContact( const QUrl& uri, ResourceManager* );
        ~OrganizationContact();
    ...
    protected:
       ...
       OrganizationContact( const QString& uri, const QUrl& type, ResourceManager* );
       OrganizationContact( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
