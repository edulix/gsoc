...
Nepomuk::Affiliation::Affiliation( ResourceManager* manager )
  : Role( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Affiliation"), manager )
{
}
...
Nepomuk::Affiliation::Affiliation( const QString& uri, ResourceManager* manager )
  : Role( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Affiliation"), manager )
{
}
...
Nepomuk::Affiliation::Affiliation( const QUrl& uri, ResourceManager* manager )
  : Role( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Affiliation"), manager )
{
}
...
Nepomuk::Affiliation::Affiliation( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::Affiliation::Affiliation( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : Role( uri, type, manager )
{
}
...
{
    return convertResourceList<PersonContact>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#hasAffiliation"), *this ) );
}
