...
Nepomuk::Gender::Gender( ResourceManager* manager )
  : Resource( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Gender"), manager )
{
}
...
Nepomuk::Gender::Gender( const QString& uri, ResourceManager* manager )
  : Resource( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Gender"), manager )
{
}
...
Nepomuk::Gender::Gender( const QUrl& uri, ResourceManager* manager )
  : Resource( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Gender"), manager )
{
}
...
Nepomuk::Gender::Gender( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::Gender::Gender( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : Resource( uri, type, manager )
{
}
...
{
    return convertResourceList<PersonContact>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#gender"), *this ) );
}
