 ...
 */
    ...
    public:
        ...
        SourceCode( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new SourceCode instance representing the resource
         * referenced by \a uri.
         */
        SourceCode( const QUrl& uri );
        SourceCode( const QUrl& uri, ResourceManager* );
        ~SourceCode();
    ...
    protected:
       ...
       SourceCode( const QString& uri, const QUrl& type, ResourceManager* );
       SourceCode( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
