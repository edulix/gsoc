...
Nepomuk::MailboxDataObject::MailboxDataObject( ResourceManager* manager )
  : DataObject( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#MailboxDataObject"), manager )
{
}
...
Nepomuk::MailboxDataObject::MailboxDataObject( const QString& uri, ResourceManager* manager )
  : DataObject( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#MailboxDataObject"), manager )
{
}
...
Nepomuk::MailboxDataObject::MailboxDataObject( const QUrl& uri, ResourceManager* manager )
  : DataObject( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#MailboxDataObject"), manager )
{
}
...
Nepomuk::MailboxDataObject::MailboxDataObject( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::MailboxDataObject::MailboxDataObject( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : DataObject( uri, type, manager )
{
}
