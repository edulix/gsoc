 ...
 */
    ...
    public:
        ...
        DataContainer( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new DataContainer instance representing the resource
         * referenced by \a uri.
         */
        DataContainer( const QUrl& uri );
        DataContainer( const QUrl& uri, ResourceManager* );
        ~DataContainer();
    ...
    protected:
       ...
       DataContainer( const QString& uri, const QUrl& type, ResourceManager* );
       DataContainer( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
