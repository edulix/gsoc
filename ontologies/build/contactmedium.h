 ...
 */
    ...
    public:
        ...
        ContactMedium( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new ContactMedium instance representing the resource
         * referenced by \a uri.
         */
        ContactMedium( const QUrl& uri );
        ContactMedium( const QUrl& uri, ResourceManager* );
        ~ContactMedium();
    ...
    protected:
       ...
       ContactMedium( const QString& uri, const QUrl& type, ResourceManager* );
       ContactMedium( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
