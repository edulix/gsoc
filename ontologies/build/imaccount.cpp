...
Nepomuk::IMAccount::IMAccount( ResourceManager* manager )
  : ContactMedium( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#IMAccount"), manager )
{
}
...
Nepomuk::IMAccount::IMAccount( const QString& uri, ResourceManager* manager )
  : ContactMedium( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#IMAccount"), manager )
{
}
...
Nepomuk::IMAccount::IMAccount( const QUrl& uri, ResourceManager* manager )
  : ContactMedium( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#IMAccount"), manager )
{
}
...
Nepomuk::IMAccount::IMAccount( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::IMAccount::IMAccount( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : ContactMedium( uri, type, manager )
{
}
...
{
    return convertResourceList<Role>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#hasIMAccount"), *this ) );
}
