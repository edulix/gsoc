...
Nepomuk::Contact::Contact( ResourceManager* manager )
  : Role( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Contact"), manager )
{
}
...
Nepomuk::Contact::Contact( const QString& uri, ResourceManager* manager )
  : Role( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Contact"), manager )
{
}
...
Nepomuk::Contact::Contact( const QUrl& uri, ResourceManager* manager )
  : Role( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Contact"), manager )
{
}
...
Nepomuk::Contact::Contact( const QString& uri, const QUrl& type, ResourceManager* manager )
  : Role( uri, type, manager )
{
}
...
Nepomuk::Contact::Contact( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : Role( uri, type, manager )
{
}
...
{
    return convertResourceList<InformationElement>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#contributor"), *this ) );
}

QList<Nepomuk::InformationElement> Nepomuk::Contact::creatorOf() const
{
    return convertResourceList<InformationElement>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#creator"), *this ) );
}

QList<Nepomuk::InformationElement> Nepomuk::Contact::publisherOf() const
{
    return convertResourceList<InformationElement>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#publisher"), *this ) );
}

QList<Nepomuk::Contact> Nepomuk::Contact::representativeOf() const
{
    return convertResourceList<Contact>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#representative"), *this ) );
}

QList<Nepomuk::Email> Nepomuk::Contact::bccOf() const
{
    return convertResourceList<Email>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#bcc"), *this ) );
}

QList<Nepomuk::Email> Nepomuk::Contact::ccOf() const
{
    return convertResourceList<Email>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#cc"), *this ) );
}

QList<Nepomuk::Message> Nepomuk::Contact::fromOf() const
{
    return convertResourceList<Message>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#from"), *this ) );
}

QList<Nepomuk::Message> Nepomuk::Contact::primaryRecipientOf() const
{
    return convertResourceList<Message>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#primaryRecipient"), *this ) );
}

QList<Nepomuk::Message> Nepomuk::Contact::recipientOf() const
{
    return convertResourceList<Message>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#recipient"), *this ) );
}

QList<Nepomuk::Message> Nepomuk::Contact::replyToOf() const
{
    return convertResourceList<Message>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#replyTo"), *this ) );
}

QList<Nepomuk::Message> Nepomuk::Contact::secondaryRecipientOf() const
{
    return convertResourceList<Message>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#secondaryRecipient"), *this ) );
}

QList<Nepomuk::Message> Nepomuk::Contact::senderOf() const
{
    return convertResourceList<Message>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#sender"), *this ) );
}

QList<Nepomuk::Email> Nepomuk::Contact::toOf() const
{
    return convertResourceList<Email>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#to"), *this ) );
}

QList<Nepomuk::FileDataObject> Nepomuk::Contact::fileOwnerOf() const
{
    return convertResourceList<FileDataObject>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#fileOwner"), *this ) );
}

QList<Nepomuk::Font> Nepomuk::Contact::foundryOf() const
{
    return convertResourceList<Font>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#foundry"), *this ) );
}
