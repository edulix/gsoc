 ...
 */
    ...
    public:
         ...
         */
        VideoIMAccount();
        VideoIMAccount( ResourceManager* );
        /**
        ...
        VideoIMAccount( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new VideoIMAccount instance representing the resource
         * referenced by \a uri.
         */
        VideoIMAccount( const QUrl& uri );
        VideoIMAccount( const QUrl& uri, ResourceManager* );
        ~VideoIMAccount();
    ...
    protected:
       ...
       VideoIMAccount( const QString& uri, const QUrl& type, ResourceManager* );
       VideoIMAccount( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
