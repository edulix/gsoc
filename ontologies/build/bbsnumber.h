 ...
 */
    ...
    public:
        ...
        BbsNumber( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new BbsNumber instance representing the resource
         * referenced by \a uri.
         */
        BbsNumber( const QUrl& uri );
        BbsNumber( const QUrl& uri, ResourceManager* );
        ~BbsNumber();
    ...
    protected:
       ...
       BbsNumber( const QString& uri, const QUrl& type, ResourceManager* );
       BbsNumber( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
