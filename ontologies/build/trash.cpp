...
Nepomuk::Trash::Trash( ResourceManager* manager )
  : DataContainer( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Trash"), manager )
{
}
...
Nepomuk::Trash::Trash( const QString& uri, ResourceManager* manager )
  : DataContainer( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Trash"), manager )
{
}
...
Nepomuk::Trash::Trash( const QUrl& uri, ResourceManager* manager )
  : DataContainer( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Trash"), manager )
{
}
...
Nepomuk::Trash::Trash( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::Trash::Trash( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : DataContainer( uri, type, manager )
{
}
