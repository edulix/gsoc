...
Nepomuk::Presentation::Presentation( ResourceManager* manager )
  : Document( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Presentation"), manager )
{
}
...
Nepomuk::Presentation::Presentation( const QString& uri, ResourceManager* manager )
  : Document( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Presentation"), manager )
{
}
...
Nepomuk::Presentation::Presentation( const QUrl& uri, ResourceManager* manager )
  : Document( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Presentation"), manager )
{
}
...
Nepomuk::Presentation::Presentation( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::Presentation::Presentation( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : Document( uri, type, manager )
{
}
