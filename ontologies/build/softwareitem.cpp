...
Nepomuk::SoftwareItem::SoftwareItem( ResourceManager* manager )
  : DataObject( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#SoftwareItem"), manager )
{
}
...
Nepomuk::SoftwareItem::SoftwareItem( const QString& uri, ResourceManager* manager )
  : DataObject( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#SoftwareItem"), manager )
{
}
...
Nepomuk::SoftwareItem::SoftwareItem( const QUrl& uri, ResourceManager* manager )
  : DataObject( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#SoftwareItem"), manager )
{
}
...
Nepomuk::SoftwareItem::SoftwareItem( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::SoftwareItem::SoftwareItem( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : DataObject( uri, type, manager )
{
}
