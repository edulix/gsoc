 ...
 */
    ...
    public:
        ...
        FaxNumber( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new FaxNumber instance representing the resource
         * referenced by \a uri.
         */
        FaxNumber( const QUrl& uri );
        FaxNumber( const QUrl& uri, ResourceManager* );
        ~FaxNumber();
    ...
    protected:
       ...
       FaxNumber( const QString& uri, const QUrl& type, ResourceManager* );
       FaxNumber( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
