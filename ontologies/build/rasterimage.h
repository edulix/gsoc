 ...
 */
    ...
    public:
        ...
        RasterImage( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new RasterImage instance representing the resource
         * referenced by \a uri.
         */
        RasterImage( const QUrl& uri );
        RasterImage( const QUrl& uri, ResourceManager* );
        ~RasterImage();
    ...
    protected:
       ...
       RasterImage( const QString& uri, const QUrl& type, ResourceManager* );
       RasterImage( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
