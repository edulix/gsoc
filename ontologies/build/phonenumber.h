 ...
 */
    ...
    public:
        ...
        PhoneNumber( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new PhoneNumber instance representing the resource
         * referenced by \a uri.
         */
        PhoneNumber( const QUrl& uri );
        PhoneNumber( const QUrl& uri, ResourceManager* );
        ~PhoneNumber();
    ...
    protected:
       ...
       PhoneNumber( const QString& uri, const QUrl& type, ResourceManager* );
       PhoneNumber( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
