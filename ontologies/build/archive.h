 ...
 */
    ...
    public:
        ...
        Archive( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Archive instance representing the resource
         * referenced by \a uri.
         */
        Archive( const QUrl& uri );
        Archive( const QUrl& uri, ResourceManager* );
        ~Archive();
    ...
    protected:
       ...
       Archive( const QString& uri, const QUrl& type, ResourceManager* );
       Archive( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
