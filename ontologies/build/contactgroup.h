 ...
 */
    ...
    public:
        ...
        ContactGroup( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new ContactGroup instance representing the resource
         * referenced by \a uri.
         */
        ContactGroup( const QUrl& uri );
        ContactGroup( const QUrl& uri, ResourceManager* );
        ~ContactGroup();
    ...
    protected:
       ...
       ContactGroup( const QString& uri, const QUrl& type, ResourceManager* );
       ContactGroup( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
