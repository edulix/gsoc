 ...
 */
    ...
    public:
        ...
        Executable( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Executable instance representing the resource
         * referenced by \a uri.
         */
        Executable( const QUrl& uri );
        Executable( const QUrl& uri, ResourceManager* );
        ~Executable();
    ...
    protected:
       ...
       Executable( const QString& uri, const QUrl& type, ResourceManager* );
       Executable( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
