 ...
 */
    ...
    public:
         ...
         */
        CellPhoneNumber();
        CellPhoneNumber( ResourceManager* );
        /**
        ...
        CellPhoneNumber( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new CellPhoneNumber instance representing the resource
         * referenced by \a uri.
         */
        CellPhoneNumber( const QUrl& uri );
        CellPhoneNumber( const QUrl& uri, ResourceManager* );
        ~CellPhoneNumber();
    ...
    protected:
       ...
       CellPhoneNumber( const QString& uri, const QUrl& type, ResourceManager* );
       CellPhoneNumber( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
