 ...
 */
    ...
    public:
        ...
        Contact( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Contact instance representing the resource
         * referenced by \a uri.
         */
        Contact( const QUrl& uri );
        Contact( const QUrl& uri, ResourceManager* );
        ~Contact();
    ...
    protected:
       ...
       Contact( const QString& uri, const QUrl& type, ResourceManager* );
       Contact( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
