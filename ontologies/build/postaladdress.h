 ...
 */
    ...
    public:
        ...
        PostalAddress( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new PostalAddress instance representing the resource
         * referenced by \a uri.
         */
        PostalAddress( const QUrl& uri );
        PostalAddress( const QUrl& uri, ResourceManager* );
        ~PostalAddress();
    ...
    protected:
       ...
       PostalAddress( const QString& uri, const QUrl& type, ResourceManager* );
       PostalAddress( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
