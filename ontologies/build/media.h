 ...
 */
    ...
    public:
        ...
        Media( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Media instance representing the resource
         * referenced by \a uri.
         */
        Media( const QUrl& uri );
        Media( const QUrl& uri, ResourceManager* );
        ~Media();
    ...
    protected:
       ...
       Media( const QString& uri, const QUrl& type, ResourceManager* );
       Media( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
