 ...
 */
    ...
    public:
        ...
        PaginatedTextDocument( ResourceManager* );
        /**
        ...
        PaginatedTextDocument( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new PaginatedTextDocument instance representing the resource
         * referenced by \a uri.
         */
        PaginatedTextDocument( const QUrl& uri );
        PaginatedTextDocument( const QUrl& uri, ResourceManager* );
        ~PaginatedTextDocument();
    ...
    protected:
       ...
       PaginatedTextDocument( const QString& uri, const QUrl& type, ResourceManager* );
       PaginatedTextDocument( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
