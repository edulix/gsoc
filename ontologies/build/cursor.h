 ...
 */
    ...
    public:
        ...
        Cursor( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Cursor instance representing the resource
         * referenced by \a uri.
         */
        Cursor( const QUrl& uri );
        Cursor( const QUrl& uri, ResourceManager* );
        ~Cursor();
    ...
    protected:
       ...
       Cursor( const QString& uri, const QUrl& type, ResourceManager* );
       Cursor( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
