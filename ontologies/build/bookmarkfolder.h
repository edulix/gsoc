 ...
 * to relate them. 
 */
    class NEPOMUK_EXPORT BookmarkFolder : public InformationElement
    {
    public:
        /**
         ...
         */
        BookmarkFolder();
        BookmarkFolder( ResourceManager* );
        /**
        ...
        BookmarkFolder( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new BookmarkFolder instance representing the resource
         * referenced by \a uri.
         */
        BookmarkFolder( const QUrl& uri );
        BookmarkFolder( const QUrl& uri, ResourceManager* );
        ~BookmarkFolder();
    ...
    protected:
       ...
       BookmarkFolder( const QString& uri, const QUrl& type, ResourceManager* );
       BookmarkFolder( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
