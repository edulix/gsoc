 ...
 */
    ...
    public:
        ...
        PersonContact( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new PersonContact instance representing the resource
         * referenced by \a uri.
         */
        PersonContact( const QUrl& uri );
        PersonContact( const QUrl& uri, ResourceManager* );
        ~PersonContact();
    ...
    protected:
       ...
       PersonContact( const QString& uri, const QUrl& type, ResourceManager* );
       PersonContact( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
