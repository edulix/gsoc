...
Nepomuk::HtmlDocument::HtmlDocument( ResourceManager* manager )
  : PlainTextDocument( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#HtmlDocument"), manager )
{
}
...
Nepomuk::HtmlDocument::HtmlDocument( const QString& uri, ResourceManager* manager )
  : PlainTextDocument( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#HtmlDocument"), manager )
{
}
...
Nepomuk::HtmlDocument::HtmlDocument( const QUrl& uri, ResourceManager* manager )
  : PlainTextDocument( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#HtmlDocument"), manager )
{
}
...
Nepomuk::HtmlDocument::HtmlDocument( const QString& uri, const QUrl& type, ResourceManager* manager )
  : PlainTextDocument( uri, type, manager )
{
}
...
Nepomuk::HtmlDocument::HtmlDocument( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : PlainTextDocument( uri, type, manager )
{
}
