 ...
 */
    ...
    public:
        ...
        Audio( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Audio instance representing the resource
         * referenced by \a uri.
         */
        Audio( const QUrl& uri );
        Audio( const QUrl& uri, ResourceManager* );
        ~Audio();
    ...
    protected:
       ...
       Audio( const QString& uri, const QUrl& type, ResourceManager* );
       Audio( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
