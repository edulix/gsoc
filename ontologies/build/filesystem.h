 ...
 */
    ...
    public:
        ...
        Filesystem( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Filesystem instance representing the resource
         * referenced by \a uri.
         */
        Filesystem( const QUrl& uri );
        Filesystem( const QUrl& uri, ResourceManager* );
        ~Filesystem();
    ...
    protected:
       ...
       Filesystem( const QString& uri, const QUrl& type, ResourceManager* );
       Filesystem( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
