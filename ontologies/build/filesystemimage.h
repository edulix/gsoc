 ...
 */
    ...
    public:
         ...
         */
        FilesystemImage();
        FilesystemImage( ResourceManager* );
        /**
        ...
        FilesystemImage( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new FilesystemImage instance representing the resource
         * referenced by \a uri.
         */
        FilesystemImage( const QUrl& uri );
        FilesystemImage( const QUrl& uri, ResourceManager* );
        ~FilesystemImage();
    ...
    protected:
       ...
       FilesystemImage( const QString& uri, const QUrl& type, ResourceManager* );
       FilesystemImage( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
