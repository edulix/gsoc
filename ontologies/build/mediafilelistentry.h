 ...
 */
    ...
    public:
         ...
         */
        MediaFileListEntry();
        MediaFileListEntry( ResourceManager* );
        /**
        ...
        MediaFileListEntry( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new MediaFileListEntry instance representing the resource
         * referenced by \a uri.
         */
        MediaFileListEntry( const QUrl& uri );
        MediaFileListEntry( const QUrl& uri, ResourceManager* );
        ~MediaFileListEntry();
    ...
    protected:
       ...
       MediaFileListEntry( const QString& uri, const QUrl& type, ResourceManager* );
       MediaFileListEntry( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
