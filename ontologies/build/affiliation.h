 ...
 */
    ...
    public:
        ...
        Affiliation( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Affiliation instance representing the resource
         * referenced by \a uri.
         */
        Affiliation( const QUrl& uri );
        Affiliation( const QUrl& uri, ResourceManager* );
        ~Affiliation();
    ...
    protected:
       ...
       Affiliation( const QString& uri, const QUrl& type, ResourceManager* );
       Affiliation( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
