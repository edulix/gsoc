 ...
 */
    ...
    public:
        ...
        IMAccount( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new IMAccount instance representing the resource
         * referenced by \a uri.
         */
        IMAccount( const QUrl& uri );
        IMAccount( const QUrl& uri, ResourceManager* );
        ~IMAccount();
    ...
    protected:
       ...
       IMAccount( const QString& uri, const QUrl& type, ResourceManager* );
       IMAccount( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
