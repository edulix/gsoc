...
Nepomuk::DataObject::DataObject( ResourceManager* manager )
  : Resource( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/01/19/nie#DataObject"), manager )
{
}
...
Nepomuk::DataObject::DataObject( const QString& uri, ResourceManager* manager )
  : Resource( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/01/19/nie#DataObject"), manager )
{
}
...
Nepomuk::DataObject::DataObject( const QUrl& uri, ResourceManager* manager )
  : Resource( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/01/19/nie#DataObject"), manager )
{
}
...
Nepomuk::DataObject::DataObject( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::DataObject::DataObject( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : Resource( uri, type, manager )
{
}
...
{
    return convertResourceList<Resource>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/01/19/nie#depends"), *this ) );
}

QList<Nepomuk::InformationElement> Nepomuk::DataObject::linksOf() const
{
    return convertResourceList<InformationElement>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/01/19/nie#links"), *this ) );
}

QList<Nepomuk::InformationElement> Nepomuk::DataObject::relatedToOf() const
{
    return convertResourceList<InformationElement>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/01/19/nie#relatedTo"), *this ) );
}

QList<Nepomuk::Contact> Nepomuk::DataObject::keyOf() const
{
    return convertResourceList<Contact>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#key"), *this ) );
}

QList<Nepomuk::OrganizationContact> Nepomuk::DataObject::logoOf() const
{
    return convertResourceList<OrganizationContact>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#logo"), *this ) );
}

QList<Nepomuk::Contact> Nepomuk::DataObject::photoOf() const
{
    return convertResourceList<Contact>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#photo"), *this ) );
}

QList<Nepomuk::Contact> Nepomuk::DataObject::soundOf() const
{
    return convertResourceList<Contact>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#sound"), *this ) );
}

QList<Nepomuk::Bookmark> Nepomuk::DataObject::bookmarksOf() const
{
    return convertResourceList<Bookmark>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#bookmarks"), *this ) );
}

QList<Nepomuk::Media> Nepomuk::DataObject::mediaStreamOf() const
{
    return convertResourceList<Media>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#hasMediaStream"), *this ) );
}
