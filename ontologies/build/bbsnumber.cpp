...
Nepomuk::BbsNumber::BbsNumber( ResourceManager* manager )
  : ModemNumber( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#BbsNumber"), manager )
{
}
...
Nepomuk::BbsNumber::BbsNumber( const QString& uri, ResourceManager* manager )
  : ModemNumber( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#BbsNumber"), manager )
{
}
...
Nepomuk::BbsNumber::BbsNumber( const QUrl& uri, ResourceManager* manager )
  : ModemNumber( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#BbsNumber"), manager )
{
}
...
Nepomuk::BbsNumber::BbsNumber( const QString& uri, const QUrl& type, ResourceManager* manager )
  : ModemNumber( uri, type, manager )
{
}
...
Nepomuk::BbsNumber::BbsNumber( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : ModemNumber( uri, type, manager )
{
}
