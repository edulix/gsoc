...
Nepomuk::Message::Message( ResourceManager* manager )
  : InformationElement( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#Message"), manager )
{
}
...
Nepomuk::Message::Message( const QString& uri, ResourceManager* manager )
  : InformationElement( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#Message"), manager )
{
}
...
Nepomuk::Message::Message( const QUrl& uri, ResourceManager* manager )
  : InformationElement( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#Message"), manager )
{
}
...
Nepomuk::Message::Message( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::Message::Message( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : InformationElement( uri, type, manager )
{
}
...
{
    return convertResourceList<Message>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#inReplyTo"), *this ) );
}

QList<Nepomuk::Message> Nepomuk::Message::referencesOf() const
{
    return convertResourceList<Message>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#references"), *this ) );
}
