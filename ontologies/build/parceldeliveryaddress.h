 ...
 */
    ...
    public:
        ...
        ParcelDeliveryAddress( ResourceManager* );
        /**
        ...
        ParcelDeliveryAddress( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new ParcelDeliveryAddress instance representing the resource
         * referenced by \a uri.
         */
        ParcelDeliveryAddress( const QUrl& uri );
        ParcelDeliveryAddress( const QUrl& uri, ResourceManager* );
        ~ParcelDeliveryAddress();
    ...
    protected:
       ...
       ParcelDeliveryAddress( const QString& uri, const QUrl& type, ResourceManager* );
       ParcelDeliveryAddress( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
