 ...
 */
    ...
    public:
        ...
        ContactList( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new ContactList instance representing the resource
         * referenced by \a uri.
         */
        ContactList( const QUrl& uri );
        ContactList( const QUrl& uri, ResourceManager* );
        ~ContactList();
    ...
    protected:
       ...
       ContactList( const QString& uri, const QUrl& type, ResourceManager* );
       ContactList( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
