 ...
 */
    ...
    public:
        ...
        EmailAddress( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new EmailAddress instance representing the resource
         * referenced by \a uri.
         */
        EmailAddress( const QUrl& uri );
        EmailAddress( const QUrl& uri, ResourceManager* );
        ~EmailAddress();
    ...
    protected:
       ...
       EmailAddress( const QString& uri, const QUrl& type, ResourceManager* );
       EmailAddress( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
