 ...
 */
    ...
    public:
         ...
         */
        MailboxDataObject();
        MailboxDataObject( ResourceManager* );
        /**
        ...
        MailboxDataObject( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new MailboxDataObject instance representing the resource
         * referenced by \a uri.
         */
        MailboxDataObject( const QUrl& uri );
        MailboxDataObject( const QUrl& uri, ResourceManager* );
        ~MailboxDataObject();
    ...
    protected:
       ...
       MailboxDataObject( const QString& uri, const QUrl& type, ResourceManager* );
       MailboxDataObject( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
