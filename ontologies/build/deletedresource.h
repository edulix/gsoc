 ...
 */
    ...
    public:
         ...
         */
        DeletedResource();
        DeletedResource( ResourceManager* );
        /**
        ...
        DeletedResource( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new DeletedResource instance representing the resource
         * referenced by \a uri.
         */
        DeletedResource( const QUrl& uri );
        DeletedResource( const QUrl& uri, ResourceManager* );
        ~DeletedResource();
    ...
    protected:
       ...
       DeletedResource( const QString& uri, const QUrl& type, ResourceManager* );
       DeletedResource( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
