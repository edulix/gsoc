 ...
 */
    ...
    public:
        ...
        DataObject( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new DataObject instance representing the resource
         * referenced by \a uri.
         */
        DataObject( const QUrl& uri );
        DataObject( const QUrl& uri, ResourceManager* );
        ~DataObject();
    ...
    protected:
       ...
       DataObject( const QString& uri, const QUrl& type, ResourceManager* );
       DataObject( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
