...
Nepomuk::Application::Application( ResourceManager* manager )
  : Software( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Application"), manager )
{
}
...
Nepomuk::Application::Application( const QString& uri, ResourceManager* manager )
  : Software( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Application"), manager )
{
}
...
Nepomuk::Application::Application( const QUrl& uri, ResourceManager* manager )
  : Software( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Application"), manager )
{
}
...
Nepomuk::Application::Application( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::Application::Application( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : Software( uri, type, manager )
{
}
