 ...
 */
    ...
    public:
        ...
        Website( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Website instance representing the resource
         * referenced by \a uri.
         */
        Website( const QUrl& uri );
        Website( const QUrl& uri, ResourceManager* );
        ~Website();
    ...
    protected:
       ...
       Website( const QString& uri, const QUrl& type, ResourceManager* );
       Website( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
