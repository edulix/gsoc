 ...
 */
    ...
    public:
        ...
        Visual( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Visual instance representing the resource
         * referenced by \a uri.
         */
        Visual( const QUrl& uri );
        Visual( const QUrl& uri, ResourceManager* );
        ~Visual();
    ...
    protected:
       ...
       Visual( const QString& uri, const QUrl& type, ResourceManager* );
       Visual( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
