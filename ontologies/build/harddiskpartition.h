 ...
 */
    ...
    public:
         ...
         */
        HardDiskPartition();
        HardDiskPartition( ResourceManager* );
        /**
        ...
        HardDiskPartition( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new HardDiskPartition instance representing the resource
         * referenced by \a uri.
         */
        HardDiskPartition( const QUrl& uri );
        HardDiskPartition( const QUrl& uri, ResourceManager* );
        ~HardDiskPartition();
    ...
    protected:
       ...
       HardDiskPartition( const QString& uri, const QUrl& type, ResourceManager* );
       HardDiskPartition( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
