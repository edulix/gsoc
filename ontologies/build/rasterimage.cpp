...
Nepomuk::RasterImage::RasterImage( ResourceManager* manager )
  : Image( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#RasterImage"), manager )
{
}
...
Nepomuk::RasterImage::RasterImage( const QString& uri, ResourceManager* manager )
  : Image( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#RasterImage"), manager )
{
}
...
Nepomuk::RasterImage::RasterImage( const QUrl& uri, ResourceManager* manager )
  : Image( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#RasterImage"), manager )
{
}
...
Nepomuk::RasterImage::RasterImage( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::RasterImage::RasterImage( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : Image( uri, type, manager )
{
}
