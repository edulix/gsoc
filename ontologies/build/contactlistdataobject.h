 ...
 */
    ...
    public:
        ...
        ContactListDataObject( ResourceManager* );
        /**
        ...
        ContactListDataObject( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new ContactListDataObject instance representing the resource
         * referenced by \a uri.
         */
        ContactListDataObject( const QUrl& uri );
        ContactListDataObject( const QUrl& uri, ResourceManager* );
        ~ContactListDataObject();
    ...
    protected:
       ...
       ContactListDataObject( const QString& uri, const QUrl& type, ResourceManager* );
       ContactListDataObject( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
