 ...
 */
    ...
    public:
        ...
        DataSource( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new DataSource instance representing the resource
         * referenced by \a uri.
         */
        DataSource( const QUrl& uri );
        DataSource( const QUrl& uri, ResourceManager* );
        ~DataSource();
    ...
    protected:
       ...
       DataSource( const QString& uri, const QUrl& type, ResourceManager* );
       DataSource( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
