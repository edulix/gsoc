 ...
 */
    ...
    public:
         ...
         */
        VoicePhoneNumber();
        VoicePhoneNumber( ResourceManager* );
        /**
        ...
        VoicePhoneNumber( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new VoicePhoneNumber instance representing the resource
         * referenced by \a uri.
         */
        VoicePhoneNumber( const QUrl& uri );
        VoicePhoneNumber( const QUrl& uri, ResourceManager* );
        ~VoicePhoneNumber();
    ...
    protected:
       ...
       VoicePhoneNumber( const QString& uri, const QUrl& type, ResourceManager* );
       VoicePhoneNumber( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
