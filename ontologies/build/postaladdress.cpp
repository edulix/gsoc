...
Nepomuk::PostalAddress::PostalAddress( ResourceManager* manager )
  : ContactMedium( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#PostalAddress"), manager )
{
}
...
Nepomuk::PostalAddress::PostalAddress( const QString& uri, ResourceManager* manager )
  : ContactMedium( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#PostalAddress"), manager )
{
}
...
Nepomuk::PostalAddress::PostalAddress( const QUrl& uri, ResourceManager* manager )
  : ContactMedium( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#PostalAddress"), manager )
{
}
...
Nepomuk::PostalAddress::PostalAddress( const QString& uri, const QUrl& type, ResourceManager* manager )
  : ContactMedium( uri, type, manager )
{
}
...
Nepomuk::PostalAddress::PostalAddress( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : ContactMedium( uri, type, manager )
{
}
...
{
    return convertResourceList<Role>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#hasPostalAddress"), *this ) );
}
