 ...
 */
    ...
    public:
         ...
         */
        MessagingNumber();
        MessagingNumber( ResourceManager* );
        /**
        ...
        MessagingNumber( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new MessagingNumber instance representing the resource
         * referenced by \a uri.
         */
        MessagingNumber( const QUrl& uri );
        MessagingNumber( const QUrl& uri, ResourceManager* );
        ~MessagingNumber();
    ...
    protected:
       ...
       MessagingNumber( const QString& uri, const QUrl& type, ResourceManager* );
       MessagingNumber( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
