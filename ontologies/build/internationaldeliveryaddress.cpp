...
Nepomuk::InternationalDeliveryAddress::InternationalDeliveryAddress( ResourceManager* manager )
  : PostalAddress( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#InternationalDeliveryAddress"), manager )
{
}
...
Nepomuk::InternationalDeliveryAddress::InternationalDeliveryAddress( const QString& uri, ResourceManager* manager )
  : PostalAddress( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#InternationalDeliveryAddress"), manager )
{
}
...
Nepomuk::InternationalDeliveryAddress::InternationalDeliveryAddress( const QUrl& uri, ResourceManager* manager )
  : PostalAddress( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#InternationalDeliveryAddress"), manager )
{
}
...
Nepomuk::InternationalDeliveryAddress::InternationalDeliveryAddress( const QString& uri, const QUrl& type, ResourceManager* manager )
  : PostalAddress( uri, type, manager )
{
}
...
Nepomuk::InternationalDeliveryAddress::InternationalDeliveryAddress( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : PostalAddress( uri, type, manager )
{
}
