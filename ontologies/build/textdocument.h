 ...
 */
    ...
    public:
        ...
        TextDocument( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new TextDocument instance representing the resource
         * referenced by \a uri.
         */
        TextDocument( const QUrl& uri );
        TextDocument( const QUrl& uri, ResourceManager* );
        ~TextDocument();
    ...
    protected:
       ...
       TextDocument( const QString& uri, const QUrl& type, ResourceManager* );
       TextDocument( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
