 ...
 */
    ...
    public:
         ...
         */
        InformationElement();
        InformationElement( ResourceManager* );
        /**
        ...
        InformationElement( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new InformationElement instance representing the resource
         * referenced by \a uri.
         */
        InformationElement( const QUrl& uri );
        InformationElement( const QUrl& uri, ResourceManager* );
        ~InformationElement();
    ...
    protected:
       ...
       InformationElement( const QString& uri, const QUrl& type, ResourceManager* );
       InformationElement( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
