 ...
 */
    ...
    public:
        ...
        PagerNumber( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new PagerNumber instance representing the resource
         * referenced by \a uri.
         */
        PagerNumber( const QUrl& uri );
        PagerNumber( const QUrl& uri, ResourceManager* );
        ~PagerNumber();
    ...
    protected:
       ...
       PagerNumber( const QString& uri, const QUrl& type, ResourceManager* );
       PagerNumber( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
