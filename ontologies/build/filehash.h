 ...
 */
    ...
    public:
        ...
        FileHash( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new FileHash instance representing the resource
         * referenced by \a uri.
         */
        FileHash( const QUrl& uri );
        FileHash( const QUrl& uri, ResourceManager* );
        ~FileHash();
    ...
    protected:
       ...
       FileHash( const QString& uri, const QUrl& type, ResourceManager* );
       FileHash( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
