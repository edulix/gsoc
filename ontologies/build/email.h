 ...
 */
    ...
    public:
        ...
        Email( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Email instance representing the resource
         * referenced by \a uri.
         */
        Email( const QUrl& uri );
        Email( const QUrl& uri, ResourceManager* );
        ~Email();
    ...
    protected:
       ...
       Email( const QString& uri, const QUrl& type, ResourceManager* );
       Email( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
