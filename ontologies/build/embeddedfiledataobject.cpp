...
Nepomuk::EmbeddedFileDataObject::EmbeddedFileDataObject( ResourceManager* manager )
  : FileDataObject( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#EmbeddedFileDataObject"), manager )
{
}
...
Nepomuk::EmbeddedFileDataObject::EmbeddedFileDataObject( const QString& uri, ResourceManager* manager )
  : FileDataObject( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#EmbeddedFileDataObject"), manager )
{
}
...
Nepomuk::EmbeddedFileDataObject::EmbeddedFileDataObject( const QUrl& uri, ResourceManager* manager )
  : FileDataObject( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#EmbeddedFileDataObject"), manager )
{
}
...
Nepomuk::EmbeddedFileDataObject::EmbeddedFileDataObject( const QString& uri, const QUrl& type, ResourceManager* manager )
  : FileDataObject( uri, type, manager )
{
}
...
Nepomuk::EmbeddedFileDataObject::EmbeddedFileDataObject( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : FileDataObject( uri, type, manager )
{
}
