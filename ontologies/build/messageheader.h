 ...
 */
    ...
    public:
        ...
        MessageHeader( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new MessageHeader instance representing the resource
         * referenced by \a uri.
         */
        MessageHeader( const QUrl& uri );
        MessageHeader( const QUrl& uri, ResourceManager* );
        ~MessageHeader();
    ...
    protected:
       ...
       MessageHeader( const QString& uri, const QUrl& type, ResourceManager* );
       MessageHeader( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
