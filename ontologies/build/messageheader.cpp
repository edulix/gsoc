...
Nepomuk::MessageHeader::MessageHeader( ResourceManager* manager )
  : Resource( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#MessageHeader"), manager )
{
}
...
Nepomuk::MessageHeader::MessageHeader( const QString& uri, ResourceManager* manager )
  : Resource( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#MessageHeader"), manager )
{
}
...
Nepomuk::MessageHeader::MessageHeader( const QUrl& uri, ResourceManager* manager )
  : Resource( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#MessageHeader"), manager )
{
}
...
Nepomuk::MessageHeader::MessageHeader( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::MessageHeader::MessageHeader( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : Resource( uri, type, manager )
{
}
...
{
    return convertResourceList<Message>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nmo#messageHeader"), *this ) );
}
