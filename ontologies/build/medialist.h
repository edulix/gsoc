 ...
 */
    ...
    public:
        ...
        MediaList( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new MediaList instance representing the resource
         * referenced by \a uri.
         */
        MediaList( const QUrl& uri );
        MediaList( const QUrl& uri, ResourceManager* );
        ~MediaList();
    ...
    protected:
       ...
       MediaList( const QString& uri, const QUrl& type, ResourceManager* );
       MediaList( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
