 ...
 */
    ...
    public:
        ...
        Document( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Document instance representing the resource
         * referenced by \a uri.
         */
        Document( const QUrl& uri );
        Document( const QUrl& uri, ResourceManager* );
        ~Document();
    ...
    protected:
       ...
       Document( const QString& uri, const QUrl& type, ResourceManager* );
       Document( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
