 ...
 */
    ...
    public:
        ...
        Font( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Font instance representing the resource
         * referenced by \a uri.
         */
        Font( const QUrl& uri );
        Font( const QUrl& uri, ResourceManager* );
        ~Font();
    ...
    protected:
       ...
       Font( const QString& uri, const QUrl& type, ResourceManager* );
       Font( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
