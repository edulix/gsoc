 ...
 */
    ...
    public:
         ...
         */
        FileDataObject();
        FileDataObject( ResourceManager* );
        /**
        ...
        FileDataObject( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new FileDataObject instance representing the resource
         * referenced by \a uri.
         */
        FileDataObject( const QUrl& uri );
        FileDataObject( const QUrl& uri, ResourceManager* );
        ~FileDataObject();
    ...
    protected:
       ...
       FileDataObject( const QString& uri, const QUrl& type, ResourceManager* );
       FileDataObject( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
