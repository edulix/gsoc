 ...
 */
    ...
    public:
        ...
        Message( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Message instance representing the resource
         * referenced by \a uri.
         */
        Message( const QUrl& uri );
        Message( const QUrl& uri, ResourceManager* );
        ~Message();
    ...
    protected:
       ...
       Message( const QString& uri, const QUrl& type, ResourceManager* );
       Message( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
