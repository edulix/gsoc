...
Nepomuk::Archive::Archive( ResourceManager* manager )
  : DataContainer( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Archive"), manager )
{
}
...
Nepomuk::Archive::Archive( const QString& uri, ResourceManager* manager )
  : DataContainer( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Archive"), manager )
{
}
...
Nepomuk::Archive::Archive( const QUrl& uri, ResourceManager* manager )
  : DataContainer( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Archive"), manager )
{
}
...
Nepomuk::Archive::Archive( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::Archive::Archive( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : DataContainer( uri, type, manager )
{
}
