...
Nepomuk::Software::Software( ResourceManager* manager )
  : InformationElement( QUrl(), QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Software"), manager )
{
}
...
Nepomuk::Software::Software( const QString& uri, ResourceManager* manager )
  : InformationElement( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Software"), manager )
{
}
...
Nepomuk::Software::Software( const QUrl& uri, ResourceManager* manager )
  : InformationElement( uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Software"), manager )
{
}
...
Nepomuk::Software::Software( const QString& uri, const QUrl& type, ResourceManager* manager )
...
Nepomuk::Software::Software( const QUrl& uri, const QUrl& type, ResourceManager* manager )
  : InformationElement( uri, type, manager )
{
}
...
{
    return convertResourceList<Software>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#conflicts"), *this ) );
}

QList<Nepomuk::Software> Nepomuk::Software::supercedesOf() const
{
    return convertResourceList<Software>( manager()->allResourcesWithProperty( QUrl("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#supercedes"), *this ) );
}
