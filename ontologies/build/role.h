 ...
 */
    ...
    public:
        ...
        Role( const QString& uriOrIdentifier, ResourceManager* );
        /**
         * Create a new Role instance representing the resource
         * referenced by \a uri.
         */
        Role( const QUrl& uri );
        Role( const QUrl& uri, ResourceManager* );
        ~Role();
    ...
    protected:
       ...
       Role( const QString& uri, const QUrl& type, ResourceManager* );
       Role( const QUrl& uri, const QUrl& type, ResourceManager* );
   };
}
